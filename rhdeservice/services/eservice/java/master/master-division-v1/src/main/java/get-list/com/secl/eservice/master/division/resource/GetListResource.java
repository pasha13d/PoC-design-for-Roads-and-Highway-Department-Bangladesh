package com.secl.eservice.master.division.resource;
...
import com.secl.eservice.master.division.request.GetListRequest;
import com.secl.eservice.master.division.response.GetListResponse;
import com.secl.eservice.master.division.response.GetListResponseBody;
import com.secl.eservice.master.division.service.GetListService;
...
@Slf4j
@RestController("masterDivisionV1GetListResource")
@RequestMapping(Api.MASTER_DIVISION_V1_RESOURCE)
public class GetListResource {
	...
	@Autowired
	@Qualifier("masterDivisionV1GetListService")
	private GetListService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PreAuthorize("securityHasPermission('"+Api.MASTER_DIVISION_V1_RESOURCE+ Api.MASTER_DIVISION_V1_GET_LIST_PATH+"')")
	@PostMapping(path = Api.MASTER_DIVISION_V1_GET_LIST_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody GetListResponse onPost(@RequestBody GetListRequest request) throws AppException {
		String url = Api.MASTER_DIVISION_V1_RESOURCE.concat(Api.MASTER_DIVISION_V1_GET_LIST_PATH);
