...
import com.secl.eservice.requisition.road.response.SaveResponseBody;
import com.secl.eservice.requisition.road.service.SaveService;
...
@Slf4j
@RestController("requisitionRoadV1SaveResource")
...
public class SaveResource {
	...
	@Autowired
	@Qualifier("requisitionRoadV1SaveService")
	private SaveService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PreAuthorize("securityHasPermission('"+Api.REQUISITION_ROAD_V1_RESOURCE+Api.REQUISITION_ROAD_V1_SAVE_PATH+"')")
	@PostMapping(path = Api.REQUISITION_ROAD_V1_SAVE_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody SaveResponse onPost(@Valid @RequestBody SaveRequest request) throws AppException {
		String url = Api.REQUISITION_ROAD_V1_RESOURCE.concat(Api.REQUISITION_ROAD_V1_SAVE_PATH);
