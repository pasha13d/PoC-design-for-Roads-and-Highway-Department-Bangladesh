...
export class RegistrationListComponent implements OnInit {
  ...
  public currentOffset: number; public totalCount = 0;
  @ViewChild('grid', { static: true }) public grid: GridComponent;
  constructor(private translate: TranslateService, private storageService: StorageService, private registrationService: RegistrationService) { }
